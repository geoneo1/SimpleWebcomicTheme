...
- [Is there a way to add a link to the first page of a comic in the navigation bar?](#PageLink)
...
<a name="PageLink">
###Is there a way to add a link to the first page of a comic in the navigation bar? 
