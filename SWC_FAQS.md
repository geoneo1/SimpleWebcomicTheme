...
You can find a full breakdown of all the options here: https://github.com/geoneo1/SimpleWebcomicTheme/blob/master/SWC_THEME_OPTIONS.md

<a name="ComicPagination"></a>
...
<a name="FirstButtonDisappeared"></a>
...
<a name="GoogleAnalyticsStatus"></a>
...
<a name="VisitedLinkColour"></a>
### How do I change the clicked-link color? 
Go to the Edit theme area, scroll to the bottom and click “Advanced options”, then copy and paste the following into the “Add custom CSS” field:
```
a:visited { color: #ff0; }
```
<a name="PostAvatarSize"></a>
